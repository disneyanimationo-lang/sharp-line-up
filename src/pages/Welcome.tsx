        ...
        <div className="w-full max-w-5xl">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto">
              Your smart queue management solution
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ boxShadow: 'var(--glow-primary)' }}></div>
              ...
              <CardHeader className="text-center pb-6 pt-8 relative z-10">
                ...
                <CardDescription className="text-base text-muted-foreground">
                  Find nearby barbershops and join queues instantly
                </CardDescription>
              </CardHeader>
            ...
            >
              {/* Glow effect on hover */}
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ boxShadow: 'var(--glow-accent)' }}></div>
              ...
              <CardHeader className="text-center pb-6 pt-8 relative z-10">
                ...
                <CardDescription className="text-base text-muted-foreground">
                  Manage your shop and customer queues efficiently
                </CardDescription>
              </CardHeader>
              <CardContent className="text-center pb-8 relative z-10">
                <Button 
